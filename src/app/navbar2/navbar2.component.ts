...
import {faLocationDot, faClock, faPhone,faHome,faShieldAlt, faBuilding,faBarsProgress,faDesktop,faPlus,faUser,faAddressBook } from '@fortawesome/free-solid-svg-icons';
